...
#define PORT8         &MODULE_P00,8
#define WAIT_TIME   3000                                                     /* Wait time constant in milliseconds   */
...
{
    /* Initialization of the LED used in this example */
    IfxPort_setPinModeOutput(PORT8, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);

    /* Switch OFF the LED (low-level active) */
    IfxPort_setPinHigh(PORT8);
}
...
void blinkPort8(void)
{
    IfxPort_togglePin(PORT8);                                                     /* Toggle the state of the LED      */
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, WAIT_TIME));    /* Wait 500 milliseconds            */
}
